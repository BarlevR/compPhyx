...
Code: Ball in a parabolic bowl, launched with initial velocity.
...
tStart = 0.0
tEnd   = 100.0
r0     = [2.0, 0.0, 0.0, 1.0]   # launched with initial velocity vy0=1
...
fig.suptitle('Damped ball in a bowl — with initial velocity')
...
# --- Plot: 3D trajectory (x, y, t) ---
fig3 = plt.figure()
ax3  = fig3.add_subplot(projection='3d')
ax3.set_xlabel('x')
ax3.set_ylabel('y')
ax3.set_zlabel('t')
ax3.set_title('3D trajectory (x, y, t)')
ax3.plot3D(sol_scipy.y[0], sol_scipy.y[1], sol_scipy.t, 'b-',  label='scipy RK45',    linewidth=0.5)
ax3.plot3D(sol_cp[1],      sol_cp[2],      sol_cp[0],   'r--', label='compPhyx RK45', linewidth=0.5)
ax3.legend()
