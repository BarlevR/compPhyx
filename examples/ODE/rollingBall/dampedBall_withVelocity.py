...
ax3.plot3D(sol_scipy.y[0], sol_scipy.y[1], sol_scipy.t, 'b-',  lw=0.5, label='scipy RK45')
ax3.plot3D(sol_cp.y[0],    sol_cp.y[1],    sol_cp.t,    'r--', lw=0.5, label=f'compPhyx {METHOD}')
ax3.legend()
