...
Code: Four-body problem — Sun, Earth, Moon, Spaceship
      Scenario: spaceship in circular orbit around Earth

      The spaceship starts at geostationary orbit radius with the
      exact circular orbital velocity.  It should remain in a stable
      circular orbit relative to Earth.
...
# --- Distances ---
dist_sun_earth  = 1.4960e+11  # m
dist_earth_moon = 3.8500e+08  # m
dist_orbit      = 4.2164e+07  # m  (geostationary orbit radius)

# --- Orbital velocities ---
vel_earth = 29780.0   # m/s  (around Sun)
vel_moon  =  1022.0   # m/s  (around Earth)
vel_orbit =  3075.0   # m/s  (circular geostationary orbit)
...
vel_ship_vec = [-vel_orbit,     vel_earth,  0.0]
...
fig1.suptitle('Sun, Earth, Moon, Spaceship — circular orbit')
...
ax1.plot(*pos_scipy(3)[:2], color='purple', lw=0.4, label='Spaceship (scipy)')
